...
# ╠══════════════════════════════════════════════════════════════════════════╣
#
# COND_CODES_OVERRIDE: 일부 조건만 실행할 경우 코드 벡터를 지정.
#   NULL(기본값)이면 모든 조건(IV 수준에서 자동 생성)을 실행.
#
#   조건 코드 자리 설명 (수준값은 00_setup.R의 IVx_LEVELS에서 수정):
#     자리 1: 채점함수 sf[4]  (1=3.00, 2=3.33, 3=3.66)
#     자리 2: 경계모수 간격   (1=1.5,  2=1.0,  3=0.5)
#     자리 3: 문항 심각도     (1=0.0,  2=0.5,  3=1.0)
#     자리 4: 능력모수 분포   (1=정적편포, 2=정규, 3=부적편포, 4=균등)
#
#   예) 특정 조건만: COND_CODES_OVERRIDE <- c("1111", "1112", "1113", "1114")
#
COND_CODES_OVERRIDE <- NULL
...
# COND_CODES_OVERRIDE가 NULL이면 ALL_COND_CODES(setup.R 자동 생성) 전체 실행
